...
> 当前工作区是 **Caddie Hosted Alpha 0.2.1**，用于 2–5 人封闭内测。
> 它使用独立的 `~/.caddie-hosted-alpha` 数据目录和独立 AI Gateway，
> 不与正常版 Caddie 共享数据、密钥或安装包。详见
> [Hosted Alpha 内测版说明](docs/HOSTED-ALPHA-内测版说明.md)。
