...
RAW_BASE="${CADDIE_GATEWAY_SOURCE_BASE:-https://raw.githubusercontent.com/Cecilia-Wendy/Caddie/alpha/hosted-ai-beta-v2/gateway}"
IMAGE_TAG=caddie-hosted-gateway:0.2.1
...
chmod 600 "$ENV_FILE"
unset DEEPSEEK_API_KEY TESTER_01_TOKEN TESTER_02_TOKEN
