...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "dist" / "update-manifest.json")
    args = parser.parse_args()

    package = args.package or ROOT / "dist" / f"Caddie-{APP_VERSION}-macos-arm64.zip"
